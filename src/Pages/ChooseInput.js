...
export default function ChooseInput() {
  ...
  return (
    <div className='container'>
      ...
      <button onClick={()=> {navigate('/success'); openBank('https://api-sandbox.commerzbank.com/auth/realms/sandbox/protocol/openid-connect/auth?response_type=code&client_id=aab6de52-86ad-4734-8761-779d1fa5deb4&redirect_uri=https://still-oasis-28539.herokuapp.com/login/oauth2/callback/commerz')}}>Continue to Commerzbank</button>
